...
<body>
    ...
    <section class="banniere" id="banniere">
        <div class="contenu">
            <h4>Votre message a été bien transmis!</h4>
            <h2>iLudothèque</h2>
            <p>Votre planet des jeux</p>
            <a href="decouvrir1.php" class="btn1">Nos jeux</a>
            <a href="login11.php" class="btn2">Reservation</a>
        </div>
    </section>
</body>
</html>